...
namespace MyTaskBoard.Infrastructure.Migrations
{
    ...
    [Migration("20240511174056_CardUpdate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyTaskBoard.Core.Entity.Board", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyTaskBoard.Core.Entity.ActivityLog", b =>
                {
                    b.HasOne("MyTaskBoard.Core.Entity.Board", "Board")
            ...
            modelBuilder.Entity("MyTaskBoard.Core.Entity.Card", b =>
                {
                    b.HasOne("MyTaskBoard.Core.Entity.Board", null)
                        .WithMany("Cards")
                        .HasForeignKey("BoardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
